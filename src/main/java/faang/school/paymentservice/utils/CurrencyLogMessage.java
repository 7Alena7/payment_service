...
public final class CurrencyLogMessage {
    ...
    public static final String FETCH_FAILURE = "Failed to fetch exchange rates: ";
    public static final String STORE_SUCCESS = "Successfully stored exchange rates";
    public static final String STORE_FAILURE = "Failed stored exchange rates";
